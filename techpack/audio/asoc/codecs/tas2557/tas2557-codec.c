...
static unsigned int tas2557_codec_read(struct snd_soc_codec* pCodec, unsigned int nRegister) {
...
static int tas2557_set_bias_level(struct snd_soc_codec* pCodec, enum snd_soc_bias_level eLevel) {
	struct tas2557_priv* pTAS2557 = snd_soc_codec_get_drvdata(pCodec);
...
int tas2557_register_codec(struct tas2557_priv* pTAS2557) {
	...
	nResult = snd_soc_register_codec(pTAS2557->dev, &soc_codec_driver_tas2557, tas2557_dai_driver,
