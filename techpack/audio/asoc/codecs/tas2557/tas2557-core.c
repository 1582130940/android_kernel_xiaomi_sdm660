 ...
 *
 * File: tas2557-core.c
 * Description: TAS2557 common functions for Android Linux
 */
...
int tas2557_enable(struct tas2557_priv *pTAS2557, bool bEnable)
{
	...
	if (nResult < 0) {
		if (pTAS2557->mnErrCode & (ERROR_DEVA_I2C_COMM | ERROR_DEVB_I2C_COMM | ERROR_PRAM_CRCCHK | ERROR_YRAM_CRCCHK | ERROR_SAFE_GUARD))
			failsafe(pTAS2557);
	}
