...
#define TAS2557_VBST_A_ON_B_ON                                                 \
	(TAS2557_VBST_A_ON |                                                   \
	 TAS2557_VBST_B_ON) /* both DevA and DevB always 8.5V */
...
struct tas2557_priv {
	...
	int (*read)(struct tas2557_priv *pTAS2557, enum channel chn,
		    unsigned int reg, unsigned int *pValue);
	int (*write)(struct tas2557_priv *pTAS2557, enum channel chn,
		     unsigned int reg, unsigned int Value);
	int (*bulk_read)(struct tas2557_priv *pTAS2557, enum channel chn,
			 unsigned int reg, unsigned char *pData,
			 unsigned int len);
	int (*bulk_write)(struct tas2557_priv *pTAS2557, enum channel chn,
			  unsigned int reg, unsigned char *pData,
			  unsigned int len);
	int (*update_bits)(struct tas2557_priv *pTAS2557, enum channel chn,
	...
	void (*enableIRQ)(struct tas2557_priv *pTAS2557, enum channel chl,
			  bool enable);
